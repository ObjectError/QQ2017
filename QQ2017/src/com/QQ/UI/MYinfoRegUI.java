...
public class MYinfoRegUI extends JFrame implements ActionListener,MouseListener,MouseMotionListener{
	...
	public MYinfoRegUI(Account myInfo,MainQQ mainqq) {
		...
		btnSave.setBounds(225, 450, 100,40);
		lblBg.add(btnSave);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==btnSave){
			...
			try {
				...
				JOptionPane.showMessageDialog(this, "年龄请输入1~150之间的数！");
			return;
			}
			if(age<0||age>150){
				JOptionPane.showMessageDialog(this, "年龄请输入1~150之间的数！");
			...
			//保存信息到数据库中的account表
			myInfo=ado.UpdatAccount(myInfo);
			//给txtQQcode文本框赋值
			txtQQcode.setText(myInfo.getQqCode() +"");
